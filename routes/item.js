    ...
    app.get('/item/:id', function(req, res) {
        ...
        pool.connect()
            .then(client => {
                ...
                let sql = "select albums.id, albums.title, albums.description, albums.released_on, albums.genre, albums.test_image, albums.is_compilation, albums.price, artists.artist_name from albums inner join artists on albums.artist_id=artists.id where albums.id=" + id + ";";
